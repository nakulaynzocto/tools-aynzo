            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h2 className="text-3xl font-black tracking-tight text-foreground flex items-center gap-3">
                        <div className="p-2.5 bg-red-500/10 rounded-2xl"><Youtube className="w-7 h-7 text-red-500" /></div>
                        YOUTUBE MONEY CALCULATOR
                    </h2>
                    <p className="text-muted-foreground font-medium mt-1">Estimate your channel Ad revenue from views and RPM.</p>
                </div>
