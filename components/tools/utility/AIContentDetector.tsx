            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="space-y-2">
                    <h2 className="text-3xl font-black tracking-tight text-foreground flex items-center gap-3">
                        <div className="p-2.5 bg-primary/10 rounded-2xl"><ScanSearch className="w-8 h-8 text-primary" /></div>
                        AI CONTENT DETECTOR
                    </h2>
                    <p className="text-muted-foreground font-medium text-lg">Analyze if content was written by AI or a human.</p>
                </div>
