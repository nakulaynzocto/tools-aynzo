        ...
        <div className="grid lg:grid-cols-12 gap-10">
            <div className="lg:col-span-5 space-y-6">
                <div className="space-y-4 bg-muted/30 p-8 rounded-[2rem] border-2 border-border">
                    <h3 className="font-black flex items-center gap-2 text-xs uppercase text-muted-foreground tracking-widest"><Settings size={14} />{tTool('optimization')}</h3>
                    <div className="space-y-4">
                        <div className="space-y-1">
                            <div className="flex justify-between items-center px-1">
                                <label className="text-[10px] font-black uppercase text-muted-foreground">{tTool('sEOPageTitle')}</label>
                        ...
                        <div className="space-y-1">
                            <div className="flex justify-between items-center px-1">
                                <label className="text-[10px] font-black uppercase text-muted-foreground">{tTool('metaDescription')}</label>
                        ...
                        <div className="space-y-1">
                            <label className="text-[10px] font-black uppercase text-muted-foreground ml-1">{tTool('simulatedURL')}</label>
            ...
            <div className="lg:col-span-7 space-y-6">
                <h3 className="text-xs font-black uppercase tracking-widest text-muted-foreground">{tTool('googleDesktopPreview')}</h3>
                    ...
                    <div className="max-w-[600px] font-sans">
                        <div className="flex items-center gap-3 mb-2 opacity-90">
                            ...
                            <div className="flex flex-col">
                                <span className="text-[12px] text-[#202124] dark:text-white font-medium leading-none mb-0.5">{tTool('exampleWeb')}</span>
                ...
                <div className="flex items-center gap-3 p-4 bg-blue-500/5 rounded-2xl border border-blue-500/10">
                    ...
                    <p className="text-[10px] text-muted-foreground font-medium uppercase tracking-tighter">{tTool('yourDescriptionIsYourAdMakeItCatchyAndInformativeToStandOut')}</p>
                </div>
            </div>
        </div>
    );
