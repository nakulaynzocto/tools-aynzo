...
export default function EditBlogPage({ params: { locale, slug } }: { params: { locale: string, slug: string } }) {
  ...
  useEffect(() => {
    ...
    const fetchBlog = async () => {
      try {
        const res = await fetch(`/api/blog/${locale}/${slug}`);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await adminApi.updateBlog(locale, slug, {
        ...formData,
